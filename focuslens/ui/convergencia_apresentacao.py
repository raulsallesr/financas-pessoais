...
from focuslens.core.convergencia_modelo import SinalCurva, SinalFocus, SinalPonta
from focuslens.ui.curva_apresentacao import formatar_bps, formatar_numero
