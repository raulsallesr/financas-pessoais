...
- `convergencia_modelo.py`: contratos, recortes, regras e narrativa pura;
- `convergencia_apresentacao.py`: formatação das métricas, sem Streamlit;
- `pagina_convergencia.py`: carregamento dos dois caches e composição visual;
