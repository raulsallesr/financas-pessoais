...
**Estado:** release candidate concluído em 2026-08-27. Licença MIT e abertura
pública concluídas em 2026-09-02; tag/release continuam opcionais e pendentes.
...
Os módulos existentes seguem três fronteiras explícitas, sem alterar seus
contratos:

```text
focuslens/core/           modelos, regras e transformações puras
...
docs/product/             plano, estratégia e metodologias
```
...
A fronteira detalhada está em `docs/architecture/ARQUITETURA_MOBILE.md`.
...
1. **Fechar o contrato do Resumo integrado — concluído em 2026-08-27.** A
   camada pura `focuslens/core/resumo_integrado.py` consome `ResumoFocusSemanal`,
...
3. **Adicionar o cenário de curva — concluído em 2026-08-27.**
   `focuslens/core/curva_cenarios.py` recebe a fotografia atual e um choque
   explícito em bps,
...
4. **Unificar metodologia e narrativa — concluído em 2026-08-27.**
   `docs/product/METODOLOGIA_FOCUSLENS.md` conecta os contratos especializados e documenta
...
5. **Fechar a publicação — concluído como release candidate em 2026-08-27.**
   ...
   fontes, licenças, dependências e histórico Git foram auditados. A licença
   MIT foi registrada e o repositório foi aberto pelo titular em 2026-09-02;
   tag/release permanecem uma decisão separada.
...
**Estado:** concluída em 2026-08-27.
`focuslens/adapters/mobile_snapshot.py` consome os quatro contratos aprovados;
`python -m scripts.gerar_mobile_snapshot` grava o JSON público de forma
...
10. **Fechar o incremento.** Atualizar `README.md`, `mobile/README.md`,
    `docs/architecture/ARQUITETURA_MOBILE.md`, este plano e `CONTEXT.md`; conferir
...
`docs/validation/VALIDACAO_CARTEIRA_LOCAL.md`.
...
roteiro físico está em `docs/validation/VALIDACAO_IMPORTACAO_B3.md`.
